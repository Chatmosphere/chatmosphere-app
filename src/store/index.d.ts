...
declare type AudioTrack = Track
declare type VideoTrack = Track 
...
// Conference STore
type User = { id:ID, user?:any, mute:boolean, volume:number, pos:Vector2, audio?:AudioTrack, video?:VideoTrack }
